...
L[3429] = {
    ["P1Frontal"]       = {group = "盘卷祭坛", name = "撕裂", text = "正面顺劈"},
    ["P1OrbDeadline"]   = {group = "盘卷祭坛", name = "搬球时限", text = "搬球时限"},
    ["P1Taunt"]         = {group = "盘卷祭坛", name = "P1 嘲讽", text = "嘲讽"},
    ["P1Soak"]          = {group = "盘卷祭坛", name = "处斩（分摊）", text = "分摊"},
    ["MindControls"]    = {group = "盘卷祭坛", name = "P2 恐惧行军（心控）", text = "心控"},
    ["P2Frontal"]       = {group = "盘卷祭坛", name = "灵魂撕裂", text = "正面顺劈"},
    ["P2Taunt"]         = {group = "盘卷祭坛", name = "P2 嘲讽", text = "嘲讽"},
    ["P2Debuffs"]       = {group = "盘卷祭坛", name = "幽暗炸弹（点名）", text = "点名炸弹"},
    ["P2Shield"]        = {group = "盘卷祭坛", name = "永恒夜幕（破盾）", text = "破盾"},
    -- ["DebuffCircle"] = {group = "Coiled Altar", name = "Orb/Bomb Circle", text = ""},
    ["EternalNightfallAbsorb"] = {group = "盘卷祭坛", name = "永恒夜幕吸收盾", text = ""},
    ["InterruptAdds"]          = {group = "盘卷祭坛", name = "恐惧哀嚎（打断）", text = "打断怪刷新"},
    ["InterruptAssignments"]   = {group = "盘卷祭坛", name = "打断分配", text = "打断"},
    ["P3OrbDeadline"]   = {group = "盘卷祭坛", name = "搬球时限", text = "搬球时限"},
    ["P2_5WrongTarget"] = {group = "盘卷祭坛", name = "易伤目标错误", text = "目标错误"},
    ["P3Frontal"]       = {group = "盘卷祭坛", name = "凋零撕裂", text = "正面顺劈"},
    ["P3Soak"]          = {group = "盘卷祭坛", name = "冷酷处斩（分摊）", text = "分摊"},
    ["P3Shield"]        = {group = "盘卷祭坛", name = "永恒夜幕（破盾）", text = "破盾"},
    ["P3Debuffs"]       = {group = "盘卷祭坛", name = "幽暗炸弹（点名）", text = "点名炸弹"},
    ["P3InterruptAdds"] = {group = "盘卷祭坛", name = "恐惧哀嚎（打断）", text = "打断怪刷新"},
    ["P3MindControls"]  = {group = "盘卷祭坛", name = "恐惧行军（心控）", text = "心控"},
